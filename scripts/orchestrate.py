...
def main():
    ...
    parser.add_argument("--manual-title", dest="manual_title", help="Manually override document title")
    parser.add_argument("--manual-author", dest="manual_author", help="Manually override document author")
    parser.add_argument("--manual-url", dest="manual_url", help="Manually provide source URL")
