    ...
    for i, slide in enumerate(last_deck_content):
        ...
        for attempt in range(args.memo_reworks + 1):
            ...
            if val_res and val_res.get("is_valid"):
                ...
                print_success(f"Memo {p_num} validation passed (Acceptable) on attempt {attempt}. Striving for perfection...")
        ...
        for i, slide in enumerate(last_deck_content):
            ...
            for attempt in range(args.slide_svg_reworks + 1):
                ...
                if val_res and val_res.get("is_valid"):
                    ...
                    print_success(f"Slide SVG {p_num} validation passed (Acceptable) on attempt {attempt}. Striving for perfection...")
            ...
            for attempt in range(args.conceptual_svg_reworks + 1):
                ...
                if val_res and val_res.get("is_valid"):
                    ...
                    print_success(f"Conceptual SVG {p_num} validation passed (Acceptable) on attempt {attempt}. Striving for perfection...")
